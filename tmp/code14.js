...
(function($)
{
	...
	$.fn.wPaint = function(option, settings)
	{
		...
		{			
			...
			$.fn.wPaint.canvas = canvas;
			$.fn.wPaint.menu = menu.menu;
		});
	}
	...
	Canvas.prototype = 
	{
		...
		{	
			...
			{				
				...
				if ($this.settings.drawDown) $this.settings.drawDown(e, $this);
			});
			...
			.mousemove(function(e)
			{
				if ($this.disabled){ return false; }
				if($this.draw){
					$this.callFunc(e, $this, 'Move');
					if ($this.settings.drawMove) $this.settings.drawMove(e, $this);
				} 
			...
			.mouseup(function(e)
			{
				...
				if($this.draw)
				{
					...
					if ($this.settings.drawUp) $this.settings.drawUp(e, $this);
				}
			});
